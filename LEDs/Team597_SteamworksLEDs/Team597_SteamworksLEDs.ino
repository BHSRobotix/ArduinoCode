/*
 * From https://www.chiefdelphi.com/forums/showthread.php?threadid=159377
 * and  https://github.com/TheLorax1313/957Steamworks/blob/master/957Steamworks/src/org/usfirst/frc/team957/robot/Robot.java
...
Adafruit_NeoPixel strip =                           //Defines an Adafruit Neopixel strip, containing 120 LEDs, using 
  Adafruit_NeoPixel(120, 6, NEO_RGB + NEO_KHZ800);  //Arduino pin #6, and using the GRB format at 800KHZ bitstream
